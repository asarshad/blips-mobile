...
class PushNotificationsController {
  ...
  Future<void> _handleForegroundMessage(RemoteMessage message) async {
    ...
    final surface = switch (target.surface) {
      NotificationSurface.articles => FeedSurface.articles,
      NotificationSurface.videos => FeedSurface.videos,
      NotificationSurface.reels => FeedSurface.reels,
    };
    _ref.read(feedDirtyAtProvider(surface).notifier).state = DateTime.now();
